...
mod tests {
    ...
    fn hash_count_smoketest_null_array_20_times() {
        ...
        assert_eq!(
            result,
            [
                152, 33, 24, 130, 189, 19, 8, 155, 108, 207, 31, 202, 129, 247, 240, 228, 171, 246,
                53, 42, 12, 57, 201, 177, 31, 20, 44, 172, 35, 63, 18, 128
            ]
        );
    }
    ...
    fn hash_smoketest_null_array_20_times() {
        ...
        assert_eq!(
            ...
            (
                ...
                20,
                [
                    152, 33, 24, 130, 189, 19, 8, 155, 108, 207, 31, 202, 129, 247, 240, 228, 171,
                    246, 53, 42, 12, 57, 201, 177, 31, 20, 44, 172, 35, 63, 18, 128
                ]
            )
        );
    }
